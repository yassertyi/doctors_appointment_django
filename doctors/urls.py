...
urlpatterns = [
    # Specialties URLs
    path('', views.specialties_list, name='specialties_list'),
    ...
    path('specialties/delete/<int:pk>/', views.specialties_delete, name='specialties_delete'),  # حذف التخصص
    ...
    path('doctors/delete/<int:pk>/', views.doctors_delete, name='doctors_delete'),  # حذف الطبيب
    ...
    path('doctorrates/delete/<int:pk>/', views.doctorrates_delete, name='doctorrates_delete'),  # حذف تقييم الطبيب
    ...
    path('doctorschedules/delete/<int:pk>/', views.doctorschedules_delete, name='doctorschedules_delete'),  # حذف جدول الطبيب
]
